...
public class MedicoPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        JButton btnPacientesAtendidos = crearBoton("PACIENTES ATENDIDOS");
        ...
        btnPacientesAtendidos.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, 
                "Funcionalidad en desarrollo - Ver pacientes atendidos", 
                "Información", 
                JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        btnHistorial.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, 
                "Funcionalidad en desarrollo - Ver historial", 
                "Información", 
                JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        buttonsPanel.add(btnPacientesAtendidos);
