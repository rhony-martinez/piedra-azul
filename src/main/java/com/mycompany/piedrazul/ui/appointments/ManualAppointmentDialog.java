...
public class ManualAppointmentDialog extends JFrame {
    ...
    private void buscarPaciente() {
        try {
            ...
            if (dniText.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Ingrese un DNI para buscar", "Info",
            ...
            JOptionPane.showMessageDialog(this, "DNI inválido. Ingrese solo números.", "Error",
    ...
    private void guardarCita() {
        try {
            ...
            if (pacienteExistente) {
                // CASO 1: Paciente existente - usar el DNI del campo de búsqueda
                String dniText = txtDni.getText().trim();
                if (dniText.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Debe ingresar el DNI del paciente", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                int dni = Integer.parseInt(dniText);
                ...
                Persona persona = personaRepository.findByDni(dni);
                if (persona == null) {
                    JOptionPane.showMessageDialog(this, "Error: No se encontró la persona con DNI: " + dni, "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (paciente == null) {
                    ...
                    if (!creado) {
                        JOptionPane.showMessageDialog(this, "Error al crear el registro de paciente", "Error",
                                JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    paciente = pacienteRepository.findById(persona.getId());
                ...
                // CASO 2: Paciente nuevo - usar el DNI del campo de registro
                if (txtDniPaciente.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(this, "DNI del paciente es obligatorio", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                if (txtPrimerNombre.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Primer nombre del paciente es obligatorio", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                if (txtPrimerApellido.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Primer apellido del paciente es obligatorio", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                if (txtTelefono.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Teléfono del paciente es obligatorio", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (personaExistente != null) {
                    JOptionPane.showMessageDialog(this,
                            "Ya existe una persona con este DNI. Por favor, busque primero.", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                try {
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(this, "Error en base de datos al crear persona: " + ex.getMessage(),
                            "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (persona == null || persona.getId() == 0) {
                    JOptionPane.showMessageDialog(this, "Error al crear la persona (ID no generado)", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
